	...
	client.on('message-new', async (mek) => {
		...
		case 'nama':
            ...
            case 'hai':
                  ...
                  break
            case 'lisfont':
                  client.sendMessage(from, 'ᜰ➢ 𝓐𝓑𝓒𝓓𝓔𝓕𝓖𝓗𝓘𝓙𝓚𝓛𝓜𝓝𝓞𝓟𝓠𝓡𝓢𝓣𝓤𝓥𝓦𝓧𝓨𝓩
...
BONUS EMOT BERAMBOD ᥬ😀 ᭄ᥬ😃᭄ᥬ😄᭄ᥬ😁᭄ᥬ😆᭄ᥬ😅᭄ᥬ😂᭄ᥬ🤣᭄ᥬ🥲᭄ᥬ☺️᭄ᥬ😊᭄ᥬ😇᭄ᥬ🙂᭄ᥬ🙃᭄ᥬ😉᭄ᥬ😌᭄ᥬ😍᭄ᥬ🥰᭄

ᵇʸ: @ⁱᵗˢᵖᵃᵖᵒʸ',MessageType.text, { quoted: mek} )
                  break
            case 'pesankosong':
